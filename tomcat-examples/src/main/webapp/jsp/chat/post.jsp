...
<body bgcolor="#FFFFFF">
	...
	<form method="POST" action='chat' name="postForm">
		<input type="hidden" name="action" value="post"> Message: <input
	...
	%>
	<a target="_blank" href="<%=chatUrl%>">Click to open a new chat
		window</a>
	<em>Note</em>: To avoid hitting the limit on the count of simultaneous
	connections to the same host, imposed by the
	<a
		href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec8.html#sec8.1.4">HTTP
		specification</a>, the second chat window should be opened using a
	different URL, e.g. with an IP address instead of the host name.
</body>
</html>
